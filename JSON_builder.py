...
def build_song_json(song):
    """
    تبدیل آبجکت song به JSON استاندارد و تمیز
    """
...
# RUN TEST
# ======================
url = input("Enter RadioJavan URL: ")

song_json = get_song_json(url)

print("\n=== FINAL JSON ===")
print(json.dumps(song_json, indent=4, ensure_ascii=False))